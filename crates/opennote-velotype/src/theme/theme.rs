...
use crate::config::{
    ...
    preferences::read_app_preferences, prune_empty_json_values, read_json_or_jsonc,
...
impl Theme {
    ...
    pub fn default_theme() -> Self {
        Self {
            name: "Velotype".into(),
            colors: ThemeColors {
                editor_background: Hsla::from(rgba(0x0a0a0aff)),
...
impl ThemeManager {
    ...
    pub fn init(cx: &mut App) {
        let theme_id = read_app_preferences()
